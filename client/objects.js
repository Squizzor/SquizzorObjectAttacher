...
const registeredObjects = {
    ...
    'bottle': { objectName: 'prop_beer_bottle', boneId: 57005, position: { x: 0.13, y: -0.12, z: -0.05, }, rotation: { x: 100, y: -220, z: 180},
        ...
        exitAnimation: {dict: '', name: '', flag: 49, durationMs: 0 } },
    'orange': { objectName: 'ng_proc_food_ornge1a', boneId: 57005, position: { x: 0.16, y: 0.01, z: -0.01, }, rotation: { x: -15, y: -150, z: -95},
        enterAnimation: {dict: 'amb@code_human_wander_eating_donut@male@idle_a', name: 'idle_c', flag: 49, durationMs: 5000 },
        exitAnimation: {dict: '', name: '', flag: 49, durationMs: 0 } },
    'burger': { objectName: 'prop_cs_burger_01', boneId: 57005, position: { x: 0.15, y: -0.02, z: -0.05, }, rotation: { x: -180, y: -150, z: -95},
        enterAnimation: {dict: 'amb@code_human_wander_eating_donut@male@idle_a', name: 'idle_c', flag: 49, durationMs: 5000 },
        exitAnimation: {dict: '', name: '', flag: 49, durationMs: 0 } }
};
